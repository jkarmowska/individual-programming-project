...
/**
 * Wypisuje wielomian. Jeśli @p p jest wielomianem stałym, wypisuje wartość współczynnika.
 * Jeśli @p p nie jest stały, wypisuje jednomiany z jego tablicy, oddzielając je znakiem @f$+@f$.
 ...
 * Wynikiem złożenia jest wielomian @f$p(q[0],q[1],q[2],…)@f$, czyli wielomian powstający przez podstawienie w wielomianie @f$p@f$ pod zmienną @f$x_i@f$ wielomianu
 * @f$q[i]@f$ dla @f$i=0,1,2,…,min(k,l)−1@f$. Jeśli @f$k<l@f$, to pod zmienne @f$x_k, …, x_{l−1}@f$ podstawiamy zera.
